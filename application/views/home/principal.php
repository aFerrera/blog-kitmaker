<div class="contenido">
  ...
  <p>Que deseas hacer?</p>
     ...
     <ul class="collapsible" data-collapsible="accordion" style="max-width: 600px; margin: 10px auto 10px auto;">
         <li>
             <div class="collapsible-header blue teal light-green lighten-4"><i class="material-icons">&#xE8B6;</i>VER POSTS</div>
         ...
         <li>
             <div class="collapsible-header blue teal light-green lighten-4"><i class="material-icons">&#xE22B;</i>AÑADIR POST</div>
             <div class="collapsible-body"><p><a href="<?=site_url('news/create')?>">CREAR NUEVO POST</a></p></div>
         </li>
         <li>
             <div class="collapsible-header blue teal light-green lighten-4"><i class="material-icons">&#xE8B6;</i>VER COMENTARIOS</div>
             <div class="collapsible-body"><p><a href="<?=site_url('news/allComents')?>">TODOS LOS COMENTARIOS</a></p></div>
         </li>
         <?php if($this->session->userdata('usuario')){?>
         <li>
             <div class="collapsible-header blue teal light-green lighten-4"><i class="material-icons">&#xE5CD;</i>LOGOUT</div>
             <div class="collapsible-body"><p><a href="<?=site_url('home/logout')?>">LOGOUT</a></p></div>
         </li>
         <?php }else{ ?>
           <li>
               <div class="collapsible-header blue teal light-green lighten-4"><i class="material-icons">&#xE853;</i>CREAR CUENTA</div>
